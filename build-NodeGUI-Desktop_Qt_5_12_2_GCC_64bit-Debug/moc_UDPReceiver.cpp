...
QT_MOC_LITERAL(3, 23, 10), // "H264Packet"
QT_MOC_LITERAL(4, 34, 6) // "packet"

    },
    "UDPReceiver\0dataReady\0\0H264Packet\0"
    "packet"
};
...
void UDPReceiver::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->dataReady((*reinterpret_cast< H264Packet(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (UDPReceiver::*)(H264Packet );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&UDPReceiver::dataReady)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void UDPReceiver::dataReady(H264Packet _t1)
{
